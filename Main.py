...
def timeAllocation():
    ...
    if avg >= 90:
        messagebox.showinfo("Green Signal Allocation Time","Traffic is very high allocation green signal time : 1 min 30 secs")
    ...
    if avg > 25 and avg <= 50:
        messagebox.showinfo("Green Signal Allocation Time","Traffic is very low allocation green signal time : 20 secs")
    if avg <=25:
        messagebox.showinfo("Green Signal Allocation Time","There is no traffic on the road : 0 secs")        
...
font = ('times', 16, 'bold')
title = Label(main, text='Smart Traffic Control System Using Canny Edge Detection Algorithm for Congregating Traffic Information',anchor=W, justify=CENTER)
